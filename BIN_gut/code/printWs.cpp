...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////
//Step 3: Calculating the Ipq matrix by using the step 2 output values
///	W_xy whose absolute value is smaller than the inpit 'thre' is filterea and set to zero
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void printWs(std::string datafolder, std::string outputfolder, double alpha, double beta, double thre)
{
	...
	////////////////////////////////////////////////////////////////////////////
	//Calculating ad printing W_xy in the form of a matrix for each node pair
	////////////////////////////////////////////////////////////////////////////
	ofstream Wfile;
	double currW_ij;
